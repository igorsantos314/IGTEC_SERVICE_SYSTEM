...
class Tela_Principal:
    ...
    def __init__(self) -> None:
        ...
        self.dict_color_msg = {"info": "Green", "warning": "DarkOrange", "error": "Red", "wait": "DimGray"}
    ...
    def menu(self):
        ...
        self.btNovo = Button(self.frameMenu, text='Novo', font=self.font_menu, image=imagem_novo_white, width=96, height=80, compound=TOP, bd=0, bg=self.color_theme, fg=self.color_contrast, command=self.TelaNovo)
    ...
    def TelaNovo(self):
        ...
        comboCategoria = ttk.Combobox(self.current_frame, font=self.font_default, width=18, state="readonly")
        ...
        def salvar():
            ...
            #SUCESSO
            th.start_new_thread(self.msg, ("info", f"SERVIÇO DE {comboCategoria.get()} CADASTRADO !", ))
        ...
        def limpar():
            ...
            comboCategoria['values'] = tuple(['N/A'])
            comboSubcategoria1['values'] = tuple(['N/A'])
            comboSubcategoria2['values'] = tuple(['N/A'])
